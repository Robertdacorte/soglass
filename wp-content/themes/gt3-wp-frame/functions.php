    ...
    <div id="comment-<?php comment_ID(); ?>" class="stand_comment">
        ...
        <div class="thiscommentbody">
            <div class="comment_info">
                ...
                <span class="date"><?php printf('%1$s', get_comment_date("j M Y")) ?></span>
...
function get_pagination($range = 10, $type = "")
{
    if ($type == "show_in_shortcodes") {
        global $paged, $wp_query_blog;
        $wp_query = $wp_query_blog;
    } else {
    ...
    #}
    if ($max_page > 1) {
        echo '<div class="fs_blog_pager"><ul class="pagerblock">';
    }
