...
if (!function_exists('get_portfolio_works')) {
    function get_portfolio_works()
    {
        ...
        while ($wp_query->have_posts()) : $wp_query->the_post();
            ...
            #Portfolio grid
            if ($html_template == "fs_grid_masonry_module") {
                $rand_height = mt_rand(240, 420);
                echo '
                <div data-category="' . $echoallterm . '" class="grid_gallery-item ' . $echoallterm . ' element">
                    <div class="filter_img gallery_item">
                        <a href="' . get_permalink() . '">
                            <img src="' . aq_resize($featured_image[0], "384", null, true, true, true) . '" alt="" width="384" height="'.$rand_height.'">
                            <div class="gallery_fadder"></div>
                            <div class="ico_gallery"></div>
                            <div class="gallery_descr">
                                <h6 class="gallery_title">' . get_the_title() . '</h6>
                                <p>' . smarty_modifier_truncate(get_the_excerpt(), 160) . '</p>
                            </div>
                        </a>
                    </div>
                </div>
            ...
            if ($html_template == "fs_grid_module") {
                ...
                <div data-category="' . $echoallterm . '" class="grid_gallery-item ' . $echoallterm . ' element">
                    <div class="filter_img gallery_item">
                        <a href="' . get_permalink() . '">
                            <img src="' . aq_resize($featured_image[0], "384", "272", true, true, true) . '" alt="" width="384" height="272">
                            <div class="gallery_fadder"></div>
                            <div class="ico_gallery"></div>
                            <div class="gallery_descr">
                                <h6 class="gallery_title">' . get_the_title() . '</h6>
                ...
                <div data-category="' . $echoallterm . '" class="' . $echoallterm . ' element row-fluid">
                    <div class="filter_img span6">
                        <a '.$target.' href="' . $linkToTheWork . '">
                            <img src="' . aq_resize($featured_image[0], "570", "340", true, true, true) . '" alt="">
                        </a>
                    </div>
            ...
            if ($html_template == "2 columns") {
                ...
                <div data-category="' . $echoallterm . '" class="' . $echoallterm . ' element">
                    <div class="filter_img portfolio_item">
                        <a href="' . get_permalink() . '">
                            <img src="' . aq_resize($featured_image[0], "570", "570", true, true, true) . '" alt="" width="570" height="570">
                            <div class="gallery_fadder"></div>
                            ...
                            <div class="gallery_descr">
                                ...
                                <p>'. smarty_modifier_truncate(get_the_excerpt(), 460) .'</p>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div data-category="' . $echoallterm . '" class="' . $echoallterm . ' element">
                    <div class="filter_img portfolio_item">
                        <a href="' . get_permalink() . '">
                            ...
                            <div class="gallery_descr">
                                <h5 class="gallery_title">' . get_the_title() . '</h5>
                                <p>'. smarty_modifier_truncate(get_the_excerpt(), 60) .'</p>
                            </div>
                        </a>
                    </div>
                </div>
