...
$pbconfig['pb_modules_enabled_for'] = array();
$pbconfig['page_settings_enabled_for'] = array('port');
$pbconfig['fullcreen_slider_enabled_for'] = array('page', 'gallery', 'post', 'port');
$pbconfig['fullwidth_slider_enabled_for'] = array();
$pbconfig['bg_image_enabled_for'] = array();
$pbconfig['bg_color_enabled_for'] = array();
...
$pbconfig['all_available_quote_types'] = array("" => "Normal", "type1" => "Colored");
...
$pbconfig['all_available_custom_buttons'] = array(
    ...
    "btn_small btn_type3" => "Small Light",
    "btn_small btn_type4" => "Small Colored",
    "btn_small btn_type5" => "Small Orange",
    "btn_small btn_type6" => "Small Yellow",
    "btn_small btn_type7" => "Small Lime",
    "btn_small btn_type8" => "Small Green",
    "btn_small btn_type9" => "Small Light Blue",
    "btn_small btn_type10" => "Small Blue",
    "btn_small btn_type11" => "Small Violet",
    "btn_small btn_type12" => "Small Purple",
    "btn_small btn_type13" => "Small Pink",
    "btn_small btn_type14" => "Small Red",
    "btn_normal btn_type1" => "Medium Dark",
    "btn_normal btn_type2" => "Medium Grey",
    "btn_normal btn_type3" => "Medium Light",
    "btn_normal btn_type4" => "Medium Colored",
    "btn_normal btn_type5" => "Medium Orange",
    "btn_normal btn_type6" => "Medium Yellow",
    "btn_normal btn_type7" => "Medium Lime",
    "btn_normal btn_type8" => "Medium Green",
    "btn_normal btn_type9" => "Medium Light Blue",
    "btn_normal btn_type10" => "Medium Blue",
    "btn_normal btn_type11" => "Medium Violet",
    "btn_normal btn_type12" => "Medium Purple",
    "btn_normal btn_type13" => "Medium Pink",
    "btn_normal btn_type14" => "Medium Red",
    "btn_large btn_type1" => "Large Dark",
    "btn_large btn_type2" => "Large Grey",
    "btn_large btn_type3" => "Large Light",
    "btn_large btn_type4" => "Large Colored",
    "btn_large btn_type5" => "Large Orange",
    "btn_large btn_type6" => "Large Yellow",
    "btn_large btn_type7" => "Large Lime",
    "btn_large btn_type8" => "Large Green",
    "btn_large btn_type9" => "Large Light Blue",
    "btn_large btn_type10" => "Large Blue",
    "btn_large btn_type11" => "Large Violet",
    "btn_large btn_type12" => "Large Purple",
    "btn_large btn_type13" => "Large Pink",
    "btn_large btn_type14" => "Large Red"
);
...
$pbconfig['all_available_highlighters'] = array(
    "highlighted_dark" => "Normal",
    "highlighted_colored" => "Colored"
);
